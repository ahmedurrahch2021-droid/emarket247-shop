...
// Replace SECTION D (Specs) till SECTION I (FAQ)
// The regex needs to be careful because of the "related products" check
const startRegex = /<!-- SECTION D: Product Specifications -->/;
const endRegex = /<!-- SECTION J: Related Products -->/;

// Finding the start and end of the block to replace
