/**
 * One-off script: PDP accordion section patcher (duplicate of .cjs version)
 ...
 * Note: Functionally identical to fix-pdp-accordion.cjs (template string syntax differs)
